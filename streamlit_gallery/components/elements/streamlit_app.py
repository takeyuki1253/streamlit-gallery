...
def main():
    ...
    if "w" not in state:
        ...
        w = SimpleNamespace(
            ...
            card=Card(board, 0, 0, 4, 6, minW=2, minH=4),
            card2=Card(board, 5, 0, 4, 6, minW=2, minH=4),
            card3=Card(board, 10, 0, 4, 6, minW=2, minH=4),
            card4=Card(board, 15, 0, 4, 6, minW=2, minH=4),
